...
return [
     ...
     *
     * You can change this to a class of your own making.
     */
    'tenant_finder' => ProviderFromRouteTenantFinder::class,

    /*
     * These fields are used by the package to determine which tenant model to use.
     */
    'tenant_model' => Provider::class,
    ...
    /*
     * This key is used to bind the current tenant in the container.
     */
    'current_tenant_container_key' => 'currentTenant',

    /**
     * The name of the column that holds the tenant id.
     *
     * This is only used when creating new models and when using the
     * BelongsToTenant relationship.
     */
    'tenant_key' => 'provider_id',

    /*
     * This class is responsible for making a tenant current.
     *
     * This class should extend `Spatie\Multitenancy\Actions\MakeTenantCurrentAction`
     *
     * You can change this to a class of your own making.
     */
    ...
    /*
     * This class is responsible for making a tenant forget.
     *
     * This class should extend `Spatie\Multitenancy\Actions\ForgetCurrentTenantAction`
     *
     * You can change this to a class of your own making.
     */
